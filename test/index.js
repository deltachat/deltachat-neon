const { Context, maybeValidAddr, getSystemInfo } = require('..')
...
test('static method maybeValidAddr()', t => {
  t.is(maybeValidAddr(null), false)
  t.is(maybeValidAddr(''), false)
  t.is(maybeValidAddr('uuu'), false)
  t.is(maybeValidAddr('dd.tt'), false)
  t.is(maybeValidAddr('tt.dd@uu'), false)
  t.is(maybeValidAddr('u@d'), false)
  t.is(maybeValidAddr('u@d.'), false)
  t.is(maybeValidAddr('u@d.t'), false)
  t.is(maybeValidAddr('u@.tt'), false)
  t.is(maybeValidAddr('@d.tt'), false)
  t.is(maybeValidAddr('user@domain.tld'), true)
  t.is(maybeValidAddr('u@d.tt'), true)
  t.end()
})
...
//   t.throws(function () {
//     ctx.configure({ addr: 'delta1@delta.localhost' })
//   }, /Missing \.mail_pw/, 'missing mail_pw throws')

//   t.throws(function () {
//     ctx.configure({ mail_pw: 'delta1' })
